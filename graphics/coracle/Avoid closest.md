<iframe 				
src="https://orllewin.github.io/coracle/drawings/experiments/avoid_closest/"
width="800"
height="450"
scrolling="no"></iframe>
...
class AvoidClosest: Drawing() {
    ...
    inner class Boid{
        ...
        fun update(): Boid {
            ...
            //While we've got the reference to closest boid, draw the relationship:
