...
I've also ported the ModularPlay manual web page to here on Obsidian: [ModularPlay](../playdate/ModularPlay.md). Doing this daily update for December Adventure has reminded me how much more convenient Obsidian is than manually writing web pages.
